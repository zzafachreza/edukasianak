...
export default function Router() {
  return (
    <Stack.Navigator>
      ...
      <Stack.Screen name="PageEdukasi" component={PageEdukasi} options={{ headerShown: false }} />
      <Stack.Screen name="PageDiskusi" component={PageDiskusi} options={{ headerShown: false }} />
      <Stack.Screen name="PageAnak" component={PageAnak} options={{ headerShown: false }} />
      <Stack.Screen name="PagePOS" component={PagePOS} options={{ headerShown: false }} />

      <Stack.Screen name="PageEdukasiVideo" component={PageEdukasiVideo} options={{ headerShown: false }} />

      <Stack.Screen name="PageEdukasiArtikel" component={PageEdukasiArtikel} options={{ headerShown: false }} />
      <Stack.Screen name="PageEdukasiArtikelDetail" component={PageEdukasiArtikelDetail} options={{ headerShown: false }} />

      <Stack.Screen name="PageAnakPOS" component={PageAnakPOS} options={{ headerShown: false }} />
      <Stack.Screen name="PageEdukasiSoal" component={PageEdukasiSoal} options={{ headerShown: false }} />
